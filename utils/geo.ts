...
export const getLocationFromReqHeaders = async (headers: NextApiRequest['headers']) => {
  try {
...
export const locationToSqlGeo = (location: { latitude: number, longitude: number } | null) => {
