...
const SideNav = () => {
  ...
  return (
    <>
      <div className="fixed hidden h-full w-[120px] flex-col items-center border-r border-zinc-700 bg-light-fg py-8  dark:bg-dark-fg sm:flex md:w-[250px] md:items-start">
        <Button
          onClick={() => router.push('/')}
