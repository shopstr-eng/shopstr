...
function fillSectionPlaceholders(
  ...
  if (!filled.productLayout && placeholders.productLayout)
    filled.productLayout = placeholders.productLayout;

  return filled;
}

function fillFooterPlaceholders(
    ...
    <div className="fixed inset-0 z-[9999] flex flex-col bg-black/70">
      ...
      <div className="flex items-center justify-between border-b border-gray-700 bg-gray-900 px-4 py-3">
        <div className="flex items-center gap-4">
          <h3 className="text-base font-bold text-white">Storefront Preview</h3>
      ...
      <div className="flex flex-1 items-start justify-center overflow-auto bg-gray-800 p-4">
        <div
          ref={containerRef}
