...
import {
  ChallengeHandler,
  NostrSigner,
} from "@/utils/nostr/signer/nostr-signer";
import { NostrManager } from "@/utils/nostr/NostrManager";
...
import { NostrNIP07Signer } from "@/utils/nostr/signer/nostr-nip07-signer";
...
export function SignerContextProvider({
  ...
  const newSigner = useCallback((type: string, args: any) => {
    switch (type.toLowerCase()) {
      ...
      case "nsec": {
        return new NostrNSECEncSigner(args, challengeHandler);
      }
      default:
      case "nip07": {
