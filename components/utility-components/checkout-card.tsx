                ...
                <div className="flex w-full flex-col gap-2">
                  <div className="flex flex-wrap items-center gap-2">
                    {productData.status !== "sold" ? (
                      <>
                        <Button
                          className={`min-w-fit bg-gradient-to-tr from-purple-700 via-purple-500 to-purple-700 text-dark-text shadow-lg dark:from-yellow-700 dark:via-yellow-500 dark:to-yellow-700 dark:text-light-text dark:text-light-text ${
