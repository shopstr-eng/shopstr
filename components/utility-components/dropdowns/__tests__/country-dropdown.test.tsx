...
jest.mock('@nextui-org/react', () => {
  ...
  return {
    ...originalModule,
    Select: jest.fn(({ children, _classNames, ...props }) => <div {...props}>{children}</div>),
    SelectSection: jest.fn(({ children, _classNames, ...props }) => <div {...props}>{children}</div>),
    SelectItem: jest.fn(({ children, _classNames, ...props }) => <div {...props}>{children}</div>),
  };
});
