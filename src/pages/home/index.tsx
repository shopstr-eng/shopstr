      ...
      <div className="w-10/12 lg:w-2/3 xl:w-1/2 bg-purple-500 rounded-md py-8 px-16">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-2">
            <HomeIcon
              className={`w-6 h-6 ${displayComponent === 'home' ? 'text-yellow-100' : ''}`}
              onClick={() => setDisplayComponent('home')}
            />
            <EnvelopeIcon
              className={`w-6 h-6 ${displayComponent === 'messages' ? 'text-yellow-100' : ''}`}
              onClick={() => setDisplayComponent('messages')}
            />
            <WalletIcon
              className={`w-6 h-6 ${displayComponent === 'wallet' ? 'text-yellow-100' : ''}`}
